      ...
      <Box className='user-review'>
        ...
        <Box className='user-review-desc'>
          <Typography variant='body2'>
            The Lake Agnes Trail is an accessible and relatively short route up to the Lake Agnes
            Tea House which was built by the Canadian Pacific Railway in 1901 as a refuge for hikers
            ...
            higher locations. The trail has an elevation gain of 400 metres and offers fantastic
            views of the Nokhu Crags and Lake Louise
          </Typography>
        </Box>
        <Box></Box>
        <Box></Box>
