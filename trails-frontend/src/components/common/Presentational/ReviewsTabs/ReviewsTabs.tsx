...
<AppBar position="static" elevation={0}>
  ...
  >
    <Tab style={{ color: '#004225', fontWeight:'bold' }} label="Reviews(4,437)" {...a11yProps(0)} />
    <Tab style={{ color: '#004225', fontWeight:'bold' }}  label="Photo(5,333)" {...a11yProps(1)} />
    <Tab style={{ color: '#004225', fontWeight:'bold' }}  label="Activities(3,999)" {...a11yProps(2)} />
    <Tab style={{ color: '#004225', fontWeight:'bold' }}  label="Completed(3,999)" {...a11yProps(3)} />
