...
const TrailInfo = () => {
  const { trailCards } = useAppSelector(
    (state) => state.appData
  );  
...
return (
  ...
  <Box className='grid-cls'>
      <Grid className='grid-cls-container' container>
          ...
          <Chip label="Horseback riding" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Snowshoing" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Bird watching" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Running" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Forest" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Lake" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Partially paved" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="River" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Views" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Waterfall" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Wildflowers" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Wildlife" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          <Chip label="Rocky" color="success" size="medium" variant="outlined" sx={{ mr: 1, mt: 1 }} />
          ...
          <Box>
            <Typography variant='h6' fontWeight='bold'>Nearby trails</Typography>   
          <>
              {
